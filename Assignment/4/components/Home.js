...
const Mail = [
  {
    ...
    title: "Internshala",
    description1: "Divyanshu, new internships in Across The Globe (ATG)",
  ...
  },
  {
    ...
    description2: "Project Support - Engineering Intern and other roles are available",
    time:"8:13 PM"
  },
  {
    id: 4,
    ...
    description1: "FINAL Chance Divyanshu, you're a catch - here's your perfect match! ",
  ...
  },
  {
   ...
   image: require("../assets/L.png"),
    ...
    description2: "Go back in time @ off *IMC PREVIEW TEXTI* LionsGate Play B...",
    time:"8:13 PM"
  },
  {
    id: 6,
    ...
    description2: "Prepare for in-demand tech roles with a degree in Comput...",
    time:"8:13 PM"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description2: "You are pre-approved for Paytm HDFC Bank Credit Card Avail No...",
    time:"8:13 PM"
  },
  {
    id: 9,
  ...
  },
  {
    ...
    image: require("../assets/I.png"),
    title: "Internshala",
    description1: "Divyanshu, new internships in IIT Bombay, Blackcoffer & more",
  ...
  },
  {
    ...
    image: require("../assets/I.png"),
    title: "ISP Team from Inter.",
    description1: "Divyanshu, iPhone '13 reasons why",
    description2: "you should check this email!- ISP Program - India's #1 Student Partner",
    time:"8:13 PM"
  },
  {
    id: 14,
    ...
    description2: "If you are unable to view the below e-mailer, please click here Hi, Stay home, stay s...",
    time:"8:13 PM"
  },
  {
    id: 15,
...
const Item = ({ item}) => (
  ...
  <TouchableOpacity onPress={handlepress}>
    ...
    <Text style={styles.text3} >{item.description2.length>40?item.description2.substring(0,38)+'...':item.description2}</Text>
